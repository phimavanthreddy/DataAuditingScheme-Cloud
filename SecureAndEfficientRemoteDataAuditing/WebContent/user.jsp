		...
		<div class="header">
			<div class="header_resize">
				...
				<div style="position: absolute; left: 210px; top: 150px">
					...
					<form action="user_verify.jsp" method="get" name="name"
						onsubmit="return validate()">
						
						<strong> USER ID:</strong><br/> 
						
						<input type="text"
							name="userid" placeholder="enter user id"></input><br/> 
						...
						<input
									type="submit" value="SignIn"></input>
						
						<p style="font-size: 15px">
							New User? <a href="uregistration.jsp">Register</a>
					    </p>
