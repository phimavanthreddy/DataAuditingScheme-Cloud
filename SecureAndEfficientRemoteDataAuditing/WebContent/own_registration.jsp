	...
	<div class="main">
		<div class="header">
			<div class="header_resize">
				<div class="logo">
					<h1>
						<a href="index.html">A secure and efficient remote data auditing scheme for cloud storage</a>
					</h1>
				</div>
				<div class="menu_nav">
					<ul>
				...
				<div style="position: absolute; left: 210px; top: 100px;">
					<h2>Owner Registraion</h2>

					<form action="ownerreg_db.jsp" method="get" name="name"
						onsubmit="return validate() ">
						<strong> USERNAME:<br /> <input type="text" name="uname"
							placeholder="Enter username"></input><br /> EMAIL ID:<br /> <input
							type="email" name="mail" placeholder="enter email id"></input><br />
							PASSWORD:<br /> <input type="password" name="password"
							placeholder="enter password"></input><br /> CONFIRM PASSWORD:<br />
							<input type="password" name="cpassword"
							placeholder="enter confirm password"></input><br /> PHONE NUMBER:<br />
							<input type="number" maxlength="10" name="phoneno"
							placeholder="enter your phoneno"></input><br /> <input
